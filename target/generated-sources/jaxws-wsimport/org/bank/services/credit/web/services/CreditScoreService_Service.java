 ...
 * 
 */
@WebServiceClient(name = "CreditScoreService", targetNamespace = "http://services.web.credit.services.bank.org/", wsdlLocation = "http://datdb.cphbusiness.dk:8080/CreditBureau/CreditScoreService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CREDITSCORESERVICE_QNAME = new QName("http://services.web.credit.services.bank.org/", "CreditScoreService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://datdb.cphbusiness.dk:8080/CreditBureau/CreditScoreService?wsdl");
    ...
    public CreditScoreService getCreditScoreServicePort() {
        return super.getPort(new QName("http://services.web.credit.services.bank.org/", "CreditScoreServicePort"), CreditScoreService.class);
    }
    ...
    public CreditScoreService getCreditScoreServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.web.credit.services.bank.org/", "CreditScoreServicePort"), CreditScoreService.class, features);
    }
